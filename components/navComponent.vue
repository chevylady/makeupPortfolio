	...
	<nav class="navbar font-mont bg-transparent fixed w-full z-20 top-0 start-0">
		<div class="relative max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
			...
			<div
				...
				id="navbar-sticky">
				<ul
					class="w-full flex flex-col items-end mt-1 p-4 md:p-0 font-semibold text-gray-900 text-xl lg:text-3xl border border-transparent rounded-lg dark:hover:text-blue-500 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:border-gray-100 uppercase">
					<li>
						<a
							href="/"
							id="/"
